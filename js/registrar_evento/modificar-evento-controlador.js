...
input_nombre_evento.disabled = true;


let idtp = sessionStorage.getItem('evento_modificar_id');
...
const obtenerEvento = async () => {
    ...
    if (validarVaciosFormato()) {
        ...
        await modificar_evento(idtp, tipo_evento, foto_evento, recinto_evento, descripcion_evento, entrada_evento, asistentes_evento, limite_evento, fechas, impuestos, descuentos);
        resetear();
    };
...
let llenarFormulario = async () => {
    let tipop = await obtener_evento_id(idtp);
    console.log(tipop);

    input_nombre_evento.value = tipop['nombre_evento'];
    input_tipo_evento.value = tipop['tipo_evento'];
    input_foto_evento.src = tipop['foto_evento'];
    input_recinto_evento.value = tipop['recinto_evento'];
    input_descripcion_evento.value = tipop['descripcion_evento'];
...
btn_modificar.addEventListener('click', obtenerEvento);
